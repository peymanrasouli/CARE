...
def main():
    ...
    for dataset_kw in datsets_list:
        ...
        for blackbox_name, blackbox_constructor in blackbox_list.items():
            ...
            # correlation between relationship and sex features
            correlations = [(0,1),
                            (1,(0,1)),
                            (2,(0,1)),
                            (3,(0,1)),
            ...
            for x_ord in X_test:
                ...
                for n in range(n_cf):
                    if relationship[n] == 0 or relationship[n] == 5:
                        preserved_config_1 += 1 if correlations[relationship[n]][1] == sex[n] else 0
                    else:
                ...
                for n in range(n_cf):
                    if relationship[n] == 0 or relationship[n] == 5:
                        preserved_config_12 += 1 if correlations[relationship[n]][1] == sex[n] else 0
                    else:
                ...
                for n in range(n_cf):
                    if relationship[n] == 0 or relationship[n] == 5:
                        preserved_config_13 += 1 if correlations[relationship[n]][1] == sex[n] else 0
                    else:
                ...
                for n in range(n_cf):
                    if relationship[n] == 0 or relationship[n] == 5:
                        preserved_config_123 += 1 if correlations[relationship[n]][1] == sex[n] else 0
                    else:
...
#                 preserved_config_1 = 0
#                 for n in range(n_cf):
#                     preserved_config_1 += 1 if correlations[education_num[n]][1] == education[n] else 0
#                 preserved_config_1 = preserved_config_1 / n_cf
#
#                 # evaluating and recovering counterfactuals of {validity, soundness} config
#                 cfs_ord_config_12, \
...
#                 preserved_config_123 = 0
#                 for n in range(n_cf):
#                     preserved_config_123 += 1 if correlations[education_num[n]][1] == education[n] else 0
#                 preserved_config_123 = preserved_config_123 / n_cf
#
#
#                 print('\n')
