...
def main():
    ...
    for dataset_kw in datsets_list:
        ...
        for blackbox_name, blackbox_constructor in blackbox_list.items():
            ...
            exists = os.path.isfile(experiment_path + 'benchmark_validity_soundness_coherency_actionability_%s_cfs_%s_%s.csv'%
                                    (dataset['name'], N, n_cf))
            if exists:
                os.remove(experiment_path + 'benchmark_validity_soundness_coherency_actionability_%s_cfs_%s_%s.csv'%
                          (dataset['name'], N, n_cf))
            cfs_results_csv = open(experiment_path + 'benchmark_validity_soundness_coherency_actionability_%s_cfs_%s_%s.csv'%
            ...
            # creating/opening a csv file for storing results
            exists = os.path.isfile(experiment_path + 'benchmark_validity_soundness_coherency_actionability_%s_eval_%s_%s.csv'%
                                    (dataset['name'], N, n_cf))
            if exists:
                os.remove(experiment_path + 'benchmark_validity_soundness_coherency_actionability_%s_eval_%s_%s.csv'%
                          (dataset['name'], N, n_cf))
            eval_results_csv = open(experiment_path + 'benchmark_validity_soundness_coherency_actionability_%s_eval_%s_%s.csv'%
                                    (dataset['name'], N, n_cf), 'a')

            header = '%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,' \
            ...
            header = '%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,' \
                     '%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s\n' % \
                      ('Outcome', 'Actionability', 'Coherency', 'Proximity', 'Connectedness', 'Distance', 'Sparsity',
                       'i-Validity', 's-Validity', 'f-Diversity', 'v-Diversity', 'd-Diversity',
                       'Outcome', 'Actionability', 'Coherency', 'Proximity', 'Connectedness', 'Distance', 'Sparsity',
                       'i-Validity', 's-Validity', 'f-Diversity', 'v-Diversity', 'd-Diversity',
                       'Outcome', 'Actionability', 'Coherency', 'Proximity', 'Connectedness', 'Distance', 'Sparsity',
                       'i-Validity', 's-Validity', 'f-Diversity', 'v-Diversity', 'd-Diversity',
            ...
            certifai_explainer = CERTIFAI(dataset, predict_fn=predict_fn, predict_proba_fn=predict_proba_fn,
                                          ACTIONABILITY=True, n_population=100, n_generation=50, n_cf=n_cf)
            ...
            for x_ord in X_test:
                ...
                try:
                    ...
                    DiCE_output = DiCEExplainer(x_ord, blackbox, predict_fn, predict_proba_fn, X_train, Y_train,
                                                ...
                                                user_preferences=user_preferences, n_cf=n_cf, desired_class="opposite",
                    ...
                    CERTIFAI_output = CERTIFAIExplainer(x_ord, X_train, Y_train, dataset, task, predict_fn,
                                                        ...
                                                        user_preferences=user_preferences, cf_class='opposite', n_cf=n_cf)
