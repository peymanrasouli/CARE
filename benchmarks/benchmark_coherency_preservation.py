        ...
        for blackbox_name, blackbox_constructor in blackbox_list.items():
            ...
            for x_ord in X_test:
                ...
                try:
                    ...
                    if relationship[0] == 0 or relationship[0] == 5:
                        preserved_care = 1 if correlations[relationship[0]][1] == sex[0] else 0
                    else:
                        preserved_care = 1
                    ...
                    if relationship[0] == 0 or relationship[0] == 5:
                        preserved_cfprototype = 1 if correlations[relationship[0]][1] == sex[0] else 0
                    else:
                    ...
                    if relationship[0] == 0 or relationship[0] == 5:
                        preserved_dice = 1 if correlations[relationship[0]][1] == sex[0] else 0
                    else:
                        preserved_dice = 1
