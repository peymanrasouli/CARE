    ...
    for dataset_kw in datsets_list:
        ...
        for blackbox_name, blackbox_constructor in blackbox_list.items():
            ...
            exists = os.path.isfile(
                experiment_path + 'benchmark_coherency_preservation_relationship_%s_%s_eval_%s_%s.csv' % (dataset['name'], blackbox_name, N, n_cf))
            if exists:
                os.remove(experiment_path + 'benchmark_coherency_preservation_relationship_%s_%s_eval_%s_%s.csv' % (dataset['name'], blackbox_name, N, n_cf))
            eval_results_csv = open(
                experiment_path + 'benchmark_coherency_preservation_relationship_%s_%s_eval_%s_%s.csv' % (dataset['name'], blackbox_name, N, n_cf), 'a')
            ...
            for x_ord in X_test:
                ...
                try:
                    ...
                    if relationship[0] == 0:
                        preserved_care = 1 if sex[0] == 1 and marital_status[0] == 2 else 0
                    elif relationship[0] == 5:
                        preserved_care = 1 if sex[0] == 0 and marital_status[0] == 2 else 0
                    else:
                        preserved_care = 1
                    ...
                    if relationship[0] == 0:
                        preserved_cfprototype = 1 if sex[0] == 1 and marital_status[0] == 2 else 0
                    elif relationship[0] == 5:
                        preserved_cfprototype = 1 if sex[0] == 0 and marital_status[0] == 2 else 0
                    else:
                        preserved_cfprototype = 1
                    ...
                    if relationship[0] == 0:
                        preserved_dice = 1 if sex[0] == 1 and marital_status[0] == 2 else 0
                    elif relationship[0] == 5:
                        preserved_dice = 1 if sex[0] == 0 and marital_status[0] == 2 else 0
                    else:
                        preserved_dice = 1
