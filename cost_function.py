...
def CostFunction(x, theta_x, discrete_indices, continuous_indices, mapping_scale, mapping_offset, feature_range,
    ...
    f2 = FeatureDistance(x, cf, feature_width, discrete_indices, continuous_indices)

    ## Objective 3: Proximity
    f3 = Proximity(theta_cf, lof_model)

    ## Objective 4: Actionable Recourse
    f4 = ActionableRecourse(x, cf, action_operation, action_priority)
    ...
    ## Objective 6: Connectedness
    f7 = Correlation(x, cf, theta_cf, corr_models, feature_width, discrete_indices, continuous_indices)
