...
## Preparing Adult dataset - Reduced Feature Set
def PrepareAdultReduced(dataset_path, dataset_name):
    ...
    continuous_features = ['age', 'capital-gain']
    discrete_features = ['education', 'occupation', 'sex', 'relationship', 'native-country']
